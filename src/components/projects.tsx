...
export default function Projects() {
    return (
        <section className="mt-28">
            ...
            <h2 id="projects" className={`${dm_serif.className} text-3xl`}>Projetos</h2>
                    ...
                    <div className="flex gap-16 justify-between">
                        ...
                        <div className="w-2/3 flex flex-col justify-between">
                            ...
                            <div className="bg-blue-950 rounded-lg mt-6 h-14 flex items-center gap-5 px-5">
                                ...
                                <Image src={tecnologias[1].img} width={33} alt="Css" title="Css" />
                                <Image src={tecnologias[2].img} width={33} alt="Javascript" title="Javascript" />
                                <Image src={tecnologias[8].img} width={33} alt="Node Js" title="Node Js" />
                                <Image src={ejs} width={33} alt="EJS" title="EJS" />
                                <Image src={mongo} width={33} alt="Mongo DB" title="Mongo DB" />
                            </div>
                        </div>
                    </div>
                </div>
